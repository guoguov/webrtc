...
go get github.com/guoguov/webrtc/examples/rtp-to-webrtc
```
...
Pion WebRTC also provides a [SampleBuilder](https://pkg.go.dev/github.com/guoguov/webrtc@v3.0.4/pkg/media/samplebuilder). This consumes RTP packets and returns samples.
