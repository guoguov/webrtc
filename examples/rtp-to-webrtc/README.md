...
go get gitlab.mty.wang/sgguo/webrtc/examples/rtp-to-webrtc
```
...
Pion WebRTC also provides a [SampleBuilder](https://pkg.go.dev/gitlab.mty.wang/sgguo/webrtc@v3.0.4/pkg/media/samplebuilder). This consumes RTP packets and returns samples.
