...
type Configuration struct {
	...
	// ICEPredictCandidateNumber indicates the number of ICE srflx candidates to predict.
	ICEPredictCandidateNumber int `json:"icePredictCandidateNumber,omitempty"`
}
